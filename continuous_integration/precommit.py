...
def main() -> int:
    ...
    if Step.DOCTEST in selects and Step.DOCTEST not in skips:
        ...
        for pth in (repo_root / "masterigayim").glob("**/*.py"):
    ...
    if (
        ...
        print("Checking that masterigayim/__init__.py and setup.py coincide...")
        exit_code = call_and_report(
            verb="check that masterigayim/__init__.py and setup.py coincide",
            cmd=[
                sys.executable,
        ...
        print("Skipped checking that masterigayim/__init__.py and setup.py coincide.")
